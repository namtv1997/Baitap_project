...
class Settings : Fragment() {
    ...
    fun onclickEvent() {
        ...
        changePasswordSetting.setOnClickListener {
            switchFragment(ChangePassword())
        }
        deactivateAccountSetting.setOnClickListener {
            switchFragment(DeactivateAccount())
        }
        termsOfServiceSetting.setOnClickListener {
            switchFragment(TermsOfService())
        }
        distanceInSetting.setOnClickListener {
            switchFragment(DistanceIn())
        }
    }
}
